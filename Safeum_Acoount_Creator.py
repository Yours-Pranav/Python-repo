#FUCK BY JOKER: @X_21393482 oN: @X_21393482 🔥❄. 
...
webbrowser.open("https://t.me/X_21393482")
Ab='\033[1;92m'
aB='\033[1;91m'
AB='\033[1;96m'
aBbs='\033[1;93m'
...
def work():
 ...
 try:
  ...
  if '"status":"Success"' in gzip:
   ...
   print(b)
   with open('SafeUM.txt', 'a') as f: f.write(username + ":hhhh | TG : @X_21393482\n")
